...
class PartnerAddCoupon : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        couponValue.filters = arrayOf<InputFilter>(MinMaxFilter(1, 100))
        ...
        addbtn.setOnClickListener{
            ...
            /*if(getCouponValue.toDouble() < 99.0 || getCouponValue.toDouble() < 1.0 ){
                couponValue.setText("")
                getCouponValue = couponValue.text.toString()
            }*/
